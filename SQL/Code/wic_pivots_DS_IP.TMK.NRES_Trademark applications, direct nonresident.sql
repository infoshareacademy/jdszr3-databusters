...
--wszystkie roczniki odczytów dla wskaŸnika "Trademark applications, direct nonresident"
--do tabeli przestawnej
select distinct  
	i.rocznik  
from indicators i
join country c2 on i.countrycode = c2.countrycode 
where i.indicatorcode='IP.TMK.NRES' and c2.currencyunit!=''
order by i.rocznik 
;

--skrajne roczniki odczytów dla wskaŸnika "Trademark applications, direct nonresident"
select distinct 
...
--wszystkie odczyty dla wskaŸnika "Trademark applications, direct nonresident"
...
from indicators i
join country c2 on i.countrycode = c2.countrycode 
where i.indicatorcode='IP.TMK.NRES' 
	and c2.currencyunit!=''
...
--najwy¿sze 10 odczytów dla wskaŸnika "Trademark applications, direct nonresident" dla 2013 roku
...
--najwy¿sze 10 odczytów dla wskaŸnika "Trademark applications, direct nonresident" dla 2011 roku
--same nazwy krajów
select 
	i.countryname 
from indicators i
...
,	(select i2.value 
	...
	where i2.indicatorcode='IP.TMK.NRES' 
	and c2.currencyunit!=''
	and i2.rocznik = '2011'
...
--najni¿sze odczyty dla wskaŸnika "Trademark applications, direct nonresident" dla 2011 roku
--wszystkie kraje, czyli currency nie równa siê ''
select 
	c2.currencyunit
,	i.countryname 
...
--najni¿sze 10 odczytów dla wskaŸnika "Trademark applications, direct nonresident" dla 2011 roku
--same nazwy krajów
select 
	i.countryname 
from indicators i
