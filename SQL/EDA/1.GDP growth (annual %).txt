...
-- Lista do sprawdzenia z Wikipedią https://pl.wikipedia.org/wiki/Lista_państw_świata_według_PKB_nominalnego_per_capita 
-- za rok 2010, mniej więcej się potwierdza
with GDP as 
(select *
from indicators i 
join country c on i.countrycode = c.countrycode 
where c.currencyunit <> ''
and	 i.indicatorname ='GDP per capita (current US$)'
and i."Year" = 2010
)
...
--GDP growth (annual %) - wzrost PKB % rocznie
