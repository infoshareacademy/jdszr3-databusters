...
--wszystkie roczniki odczytów dla wskaŸnika "CO2 emissions (kg per 2005 US$ of GDP)"
--do tabeli przestawnej
select distinct  
	i.rocznik  
from indicators i
join country c2 on i.countrycode = c2.countrycode 
where i.indicatorcode='EN.ATM.CO2E.KD.GD' and c2.currencyunit!=''
order by i.rocznik 
;

--skrajne roczniki odczytów dla wskaŸnika "CO2 emissions (kg per 2005 US$ of GDP)"
select distinct 
...
--wiêkszoœæ krajów do 2011, ale wiele równie¿ 2005/7/9
select distinct 
	i.countryname 
...
--wszystkie odczyty dla wskaŸnika "CO2 emissions (kg per 2005 US$ of GDP)"
...
from indicators i
join country c2 on i.countrycode = c2.countrycode 
where i.indicatorcode='EN.ATM.CO2E.KD.GD' 
	and c2.currencyunit!=''
...
--najwy¿sze 10 odczytów dla wskaŸnika "CO2 emissions (kg per 2005 US$ of GDP)" dla 2011 roku
...
,	(select i2.value 
	...
	where i2.indicatorcode='EN.ATM.CO2E.KD.GD' 
	and c2.currencyunit!=''
	and i2.rocznik = '2011'
...
--najni¿sze odczyty dla wskaŸnika "CO2 emissions (kg per 2005 US$ of GDP)" dla 2011 roku
--wszystkie kraje, czyli currency nie równa siê ''
select 
	c2.currencyunit
,	i.countryname 
...
--najni¿sze 10 odczytów dla wskaŸnika "CO2 emissions (kg per 2005 US$ of GDP)" dla 2011 roku
--same nazwy krajów
select 
	i.countryname 
from indicators i
