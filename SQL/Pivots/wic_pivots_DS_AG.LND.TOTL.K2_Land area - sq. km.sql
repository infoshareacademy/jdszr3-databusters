...
--wszystkie roczniki odczytów dla wskaŸnika "Land area (sq. km)"
--do tabeli przestawnej
select distinct  
	i.rocznik  
from indicators i
join country c2 on i.countrycode = c2.countrycode 
where i.indicatorcode='AG.LND.TOTL.K2' and c2.currencyunit!=''
order by i.rocznik 
;

--skrajne roczniki odczytów dla wskaŸnika "Land area (sq. km)"
select distinct 
...
--wszystkie odczyty dla wskaŸnika "Land area (sq. km)"
...
from indicators i
join country c2 on i.countrycode = c2.countrycode 
where i.indicatorcode='AG.LND.TOTL.K2' 
	and c2.currencyunit!=''
...
--najwy¿sze 10 odczytów dla wskaŸnika "Land area (sq. km)" dla 2014 roku
...
,	(select i2.value 
	...
	where i2.indicatorcode='AG.LND.TOTL.K2' 
	and c2.currencyunit!=''
	and i2.rocznik = '2014'
...
--najni¿sze odczyty dla wskaŸnika "Land area (sq. km)" dla 2014 roku
--wszystkie kraje, czyli currency nie równa siê ''
select 
	c2.currencyunit
,	i.countryname 
...
--najni¿sze 10 odczytów dla wskaŸnika "Land area (sq. km)" dla 2014 roku
--same nazwy krajów
select 
	i.countryname 
from indicators i
